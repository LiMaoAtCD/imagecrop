...
//    self.cropMaskView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.8];
    ...
    self.cropMaskView.backgroundColor = [UIColor clearColor];
...
-(void)calculateProportion{
    CGFloat width = self.cropView.bounds.size.width;
    CGFloat height = self.cropView.bounds.size.height;
    
    CGFloat totalWidth = self.cropMaskView.bounds.size.width;
    imageScale = self.image.size.width / totalWidth;
    
    NSLog(@"w:%f, h: %f", width * imageScale, height * imageScale);
}

- (IBAction)pinchCropView:(id)sender {
//
//    UIPinchGestureRecognizer * pinch = (UIPinchGestureRecognizer*)sender;
//    CGFloat scale = pinch.scale;
//    if (pinch.state == UIGestureRecognizerStateBegan) {
//        startPinchViewFrame = pinch.view.frame;
...
//        startPinchViewFrame = self.cropMaskView.frame;
...
//        
//        CGFloat width = startPinchViewFrame.size.width * scale;
//        CGFloat height = startPinchViewFrame.size.height * scale;
//        CGFloat x = startPinchViewFrame.origin.x;
//        CGFloat y = startPinchViewFrame.origin.y;
//        
//        CGFloat new_x = (x + (startPinchViewFrame.size.width - width) / 2);
//        CGFloat new_y = (y + (startPinchViewFrame.size.height - height) / 2);
//        
//
...
//        CGFloat maxX = CGRectGetMaxX(self.imageHolderView.frame);
//
//        
...
//        CGFloat maxY = CGRectGetMaxY(self.imageHolderView.frame);
//
//        
//        
//        CGFloat new_width = startPinchViewFrame.size.width - (new_x - x) * 2;
//        CGFloat new_height = startPinchViewFrame.size.height - (new_y - y) * 2;
//
//        if (new_x <= minX) {
//            new_x = minX;
//            new_width = startPinchViewFrame.size.width - (new_x - x) * 2;
//        }
//        
//        if (new_y <= minY) {
//            new_y = minY;
//            new_height = startPinchViewFrame.size.height - (new_y - y) * 2;
//        }
//        
//        if (new_x + new_width >= maxX) {
//            new_width = width;
//            new_x = maxX - width;
//        }
//        
//        if (new_y + new_height >= maxY) {
//            new_height = height;
//            new_y = maxY - height;
//            
//            if (new_y <= minY) {
...
//
//        
//        pinch.view.frame = CGRectMake(new_x, new_y, new_width, new_height);
//
//    }
//    
//    [self resetCropMask];
